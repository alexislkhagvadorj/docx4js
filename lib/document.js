...
var Document = function () {
  ...
  _createClass(Document, [{
    ...
    value: function parse(visitorFactories) {
      this.getPart('core-properties').documentElement.$1('keywords,description,title').forEach(function (x) {
      ...
      this.getPart('extended-properties').documentElement.$1('Template').forEach(function (x) {
        var v = x.textContent.trim();
        v.length && (this[x.localName] = v);
      }, this.props);
    }

...
var Table = function (_Style) {
  ...
  _createClass(Table, [{
    ...
    value: function parse(factories) {
      ...
      for (var styles = this.wXml.$1('tblStylePr'), len = styles.length, i = 0; i < len; i++) {
    ...
    value: function _iterate(f, factories, visitors) {
      var pr = null;
      (pr = this.wXml.$2('>tblPr:not(:empty)')) && new this.constructor.Properties(pr, this.wDoc, this).parse(visitors);
      (pr = this.wXml.$2('>trPr:not(:empty)')) && new this.constructor.RowProperties(pr, this.wDoc, this).parse(visitors);
      (pr = this.wXml.$2('>tcPr:not(:empty)')) && new this.constructor.CellProperties(pr, this.wDoc, this).parse(visitors);
      (pr = this.wXml.$2('>pPr:not(:empty)')) && new _paragraph2.default.Properties(pr, this.wDoc, this).parse(visitors);
      (pr = this.wXml.$2('>rPr:not(:empty)')) && new _inline2.default.Properties(pr, this.wDoc, this).parse(visitors);
    }
  }, {
    key: 'getTarget',
